...
{
    public class RoboGrowWaterPlantsStage2Asses : MonoBehaviour
    {
     ...
     //   public Animator radish2WaterToReset;
        ...
        public Button TTSJobotPlantAsses1Stage5;

        public TextMeshProUGUI jobotIntroStage2PlantAsses1Stage5;
        ...
        private void Awake()
        {
            ...
            TTSJobotPlantAsses1Stage5.onClick.AddListener(JobotStage5Plant1Asses1);
        ...
        void Start()
        {
            ...
            jobotIntroStage2PlantAsses1Stage5.enabled = false;
            ...
            if (rgMain.currentGameStage == 2)
            {
                ...
                if (currentStage2TreeText == 6)
                {
                    if (!stage2Text6Read)
                    {
                        ...
                        // TTSJobotIncorrectGuess.gameObject.SetActive(tr);
            ...
            if (rgMain.currentGameStage == 3)
            {
                if (currentStage3TreeText == 1)
                {
                    if (!stage3Text1Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses1Stage3.gameObject.SetActive(true);
                        jobotIntroStage2PlantAsses1aStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 2)
                {
                    if (!stage3Text2Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses1Stage3.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses1aStage3.gameObject.SetActive(true);
                        jobotIntroStage2PlantAsses1bStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 3)
                {
                    if (!stage3Text3Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses1aStage3.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses1bStage3.gameObject.SetActive(true);
                        jobotIntroStage2PlantAsses1cStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 4)
                {
                    if (!stage3Text4Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses1bStage3.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses1cStage3.gameObject.SetActive(true);
                ...
                if (currentStage3TreeText == 5)
                {
                    if (!stage3Text5Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses1cStage3.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses1dStage3.gameObject.SetActive(true);
                        hangmanGamePanal.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 7)
                {
                    ...
                    if (!stage3Text7Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses1cStage3.gameObject.SetActive(false);
                      //  jobotIntroStage2PlantAsses1dStage3.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses1IncorrectGuessStage3.gameObject.SetActive(true);
            ...
            if (rgMain.currentGameStage == 4)
            {
                if (currentStage4TreeText == 1)
                {
                    if (!stage4Text1Read)
                    {
                        ...
                        susan1plantBoxToDisable.enabled = false;
                        jobotIntroStage2PlantAsses1Stage4.gameObject.SetActive(true);
                        jobotIntroStage2PlantAsses1aStage4.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses1IncorrectGuessStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 2)
                {
                    if (!stage4Text2Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses1Stage4.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses1aStage4.gameObject.SetActive(true);
                        jobotIntroStage2PlantAsses1bStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 3)
                {
                    ...
                    if (!stage4Text3Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses1aStage4.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses1bStage4.gameObject.SetActive(true);
                        jobotIntroStage2PlantAsses1cCorrectStage4.gameObject.SetActive(false);
                        mazeGamePanal.gameObject.SetActive(true);
                ...
                if (currentStage4TreeText == 4)
                {
                    if(!stage4Text4Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses1bStage4.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses1cCorrectStage4.gameObject.SetActive(true);
                        mazeGamePanal.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 5)
                {
                    if (!stage4Text5Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses1IncorrectGuessStage4.gameObject.SetActive(true);
            ...
            if (rgMain.currentGameStage == 5)
            {
                if (currentStage5TreeText == 1)
                {
                    if (!lastBool)
                    {
                        ...
                        susan1plantBoxToDisable.enabled = false;
                        jobotIntroStage2PlantAsses1Stage5.gameObject.SetActive(true);
                        jobotIntroStage2PlantAsses1Stage5.enabled = true;
                        TTSJobotPlantAsses1Stage5.gameObject.SetActive(true);
        ...
        public void ReturnToPlayerCamFromTreeFinal()
        {
            ...
            robotNavMeshAgentToStop.GetComponent<NavMeshAgent>().isStopped = false;
            susanToDisable.gameObject.SetActive(false);
