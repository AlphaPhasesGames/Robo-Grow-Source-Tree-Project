...
{
    public class RoboGrowWaterplantsstageasses5 : MonoBehaviour
    {
        //Radish 1
        ...
        public Button TTSJobotPlantAsses5Stage3;
        public Button TTSJobotPlantAsses5aStage3;
        public Button TTSJobotPlantAsses5bStage3;
        public Button TTSJobotPlantAsses5cStage3;
        public Button TTSJobotPlantAsses5dStage3;
        public Button TTSJobotIncorrectGuessAsses5Stage3;

        public TextMeshProUGUI jobotIntroStage3PlantAsses5Stage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses5aStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses5bStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses5cStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses5dStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses5IncorrectGuessStage3;
        ...
        public Button TTSJobotPlantAsses5Stage4;
        public Button TTSJobotPlantAsses5aStage4;
        public Button TTSJobotPlantAsses5bStage4;
        public Button TTSJobotPlantAsses5cCorrectStage4;
        public Button TTSJobotIncorrectGuessStage4;

        public TextMeshProUGUI jobotIntroStage2PlantAsses5Stage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses5aStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses5bStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses5cCorrectStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses5IncorrectGuessStage4;
        #endregion
        ...
        private void Awake()
        {
            ...
            TTSJobotPlantAsses5Stage3.onClick.AddListener(JobotStage3Plant1Asses);
            TTSJobotPlantAsses5aStage3.onClick.AddListener(JobotStage3Plant1Asses2);
            TTSJobotPlantAsses5bStage3.onClick.AddListener(JobotStage3Plant1Asses3);
            TTSJobotPlantAsses5cStage3.onClick.AddListener(JobotStage3Plant1Asses4);
            TTSJobotPlantAsses5dStage3.onClick.AddListener(JobotStage3Plant1Asses5);
            TTSJobotIncorrectGuessAsses5Stage3.onClick.AddListener(JobotStage3Plant1Asses6);
            ...
            TTSJobotPlantAsses5Stage4.onClick.AddListener(JobotStage4Plant1Asses);
            TTSJobotPlantAsses5aStage4.onClick.AddListener(JobotStage4Plant1Asses2);
            TTSJobotPlantAsses5bStage4.onClick.AddListener(JobotStage4Plant1Asses3);
            TTSJobotPlantAsses5cCorrectStage4.onClick.AddListener(JobotStage4Plant1Asses4);
       ...
       //     jobotIntroStage3PlantAsses5IncorrectGuessStage3.enabled = false;
            ...
            jobotIntroStage2PlantAsses5bStage4.enabled = false;
            jobotIntroStage2PlantAsses5cCorrectStage4.enabled = false;
            jobotIntroStage2PlantAsses5IncorrectGuessStage4.enabled = false;
        ...
        void Update()
        {
            ...
            if (rgMain.currentGameStage == 4)
            {
                if (currentStage4TreeText == 1)
                {
                    ...
                    jobotIntroStage2PlantAsses5Stage4.enabled = true;
                    jobotIntroStage2PlantAsses5aStage4.enabled = false;
                    jobotIntroStage2PlantAsses5bStage4.enabled = false;
                    jobotIntroStage2PlantAsses5cCorrectStage4.enabled = false;

                    TTSJobotPlantAsses5Stage4.gameObject.SetActive(true);
                    TTSJobotPlantAsses5aStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses5bStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses5cCorrectStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 2)
                {
                    ...
                    susan1plantBoxToDisable.enabled = false;
                    jobotIntroStage2PlantAsses5Stage4.enabled = false;
                    jobotIntroStage2PlantAsses5aStage4.enabled = true;
                    jobotIntroStage2PlantAsses5bStage4.enabled = false;
                    jobotIntroStage2PlantAsses5cCorrectStage4.enabled = false;
                    mazeGamePanal.gameObject.SetActive(true);
                    TTSJobotPlantAsses5Stage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses5aStage4.gameObject.SetActive(true);
                    TTSJobotPlantAsses5bStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses5cCorrectStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 3)
                {
                    ...
                    jobotIntroStage2PlantAsses5Stage4.enabled = false;
                    jobotIntroStage2PlantAsses5aStage4.enabled = false;
                    jobotIntroStage2PlantAsses5bStage4.enabled = true;
                    jobotIntroStage2PlantAsses5cCorrectStage4.enabled = false;
                    mazeGamePanal.gameObject.SetActive(true);

                    TTSJobotPlantAsses5Stage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses5aStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses5bStage4.gameObject.SetActive(true);
                    TTSJobotPlantAsses5cCorrectStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 4)
                {
                    ...
                    jobotIntroStage2PlantAsses5aStage4.enabled = false;
                    jobotIntroStage2PlantAsses5bStage4.enabled = false;
                    jobotIntroStage2PlantAsses5cCorrectStage4.enabled = true;
                    mazeGamePanal.gameObject.SetActive(false);

                    TTSJobotPlantAsses5Stage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses5aStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses5bStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses5cCorrectStage4.gameObject.SetActive(true);
                ...
                if (currentStage4TreeText == 5)
                {
                    ...
                    jobotIntroStage2PlantAsses5IncorrectGuessStage4.enabled = true;
        ...
        public void ReturnToPlayerCamFromTreeFinal()
        {
            ...
            robotNavMeshAgentToStop.GetComponent<NavMeshAgent>().isStopped = false;
            radishToDisable.gameObject.SetActive(false);
