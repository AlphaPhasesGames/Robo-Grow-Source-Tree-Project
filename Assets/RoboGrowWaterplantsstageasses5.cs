            ...
            if (rgMain.currentGameStage == 4)
            {
                if (currentStage4TreeText == 1)
                {
                    if (!stage4Text1Read)
                    {
                        ...
                        susan1plantBoxToDisable.enabled = false;
                        jobotIntroStage2PlantAsses5Stage4.gameObject.SetActive(true);
                        jobotIntroStage2PlantAsses5aStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 2)
                {
                    if (!stage4Text2Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses5Stage4.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses5aStage4.gameObject.SetActive(true);
                        jobotIntroStage2PlantAsses5bStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 3)
                {
                    ...
                    if (!stage4Text3Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses5aStage4.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses5bStage4.gameObject.SetActive(true);
                        jobotIntroStage2PlantAsses5cCorrectStage4.gameObject.SetActive(false);
                        mazeGamePanal.gameObject.SetActive(true);
                ...
                if (currentStage4TreeText == 4)
                {
                    if (!stage4Text4Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses5bStage4.gameObject.SetActive(false);
                        jobotIntroStage2PlantAsses5cCorrectStage4.gameObject.SetActive(true);
                        mazeGamePanal.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 5)
                {
                    if (!stage4Text5Read)
                    {
                        ...
                        jobotIntroStage2PlantAsses5IncorrectGuessStage4.gameObject.SetActive(true);
