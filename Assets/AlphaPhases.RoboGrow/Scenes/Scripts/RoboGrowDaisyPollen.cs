...
{
    public class RoboGrowDaisyPollen : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            if (isPollenOnPlayer)
            {
                if (!pollenAttached)
                {
                        ...
                        bController.daisyPollenAttached = bController.daisyPollenAttached + 1;
                        pollenAttached = true;
            ...
            {
                rgPollenCount.amountOfDaisyPollenCollected = rgPollenCount.amountOfDaisyPollenCollected + 1;
                this.gameObject.transform.parent = null;
                Destroy(this.gameObject);
                bController.daisyPollenAttached = 0;
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (other.CompareTag("DaisyStigma"))
            {
