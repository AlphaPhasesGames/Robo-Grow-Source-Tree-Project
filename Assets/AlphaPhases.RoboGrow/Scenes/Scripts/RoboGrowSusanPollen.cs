...
{
    public class RoboGrowSusanPollen : MonoBehaviour
    {
       ...
       // public GameObject pollenToDestroy;
        ...
        void FixedUpdate()
        {
            if (isPollenOnPlayer)
            {
                ...
                { 
                        ...
                        bController.pollenAttached = bController.pollenAttached + 1;
                        pollenAttached = true;
            ...
            {
                rgPollenCount.amountOfSusansPollenCollected = rgPollenCount.amountOfSusansPollenCollected + 1;
                this.gameObject.transform.parent = null;
                Destroy(this.gameObject);
                bController.pollenAttached = 0;
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (other.CompareTag("SusanStigma"))
            {
