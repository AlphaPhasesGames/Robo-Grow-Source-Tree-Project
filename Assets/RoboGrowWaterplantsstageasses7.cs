            ...
            if (rgMain.currentGameStage == 3)
            {
                if (currentStage3TreeText == 1)
                {
                    if (!stage3Text1Read)
                    {
                        ...
                        jobotIntroStage3PlantAsses7Stage3.gameObject.SetActive(true);
                        jobotIntroStage3PlantAsses7aStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 2)
                {
                    if (!stage3Text2Read)
                    {
                        ...
                        jobotIntroStage3PlantAsses7Stage3.gameObject.SetActive(false);
                        jobotIntroStage3PlantAsses7aStage3.gameObject.SetActive(true);
                        jobotIntroStage3PlantAsses7bStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 3)
                {
                    if (!stage3Text3Read)
                    {
                        ...
                        jobotIntroStage3PlantAsses7aStage3.gameObject.SetActive(false);
                        jobotIntroStage3PlantAsses7bStage3.gameObject.SetActive(true);
                        jobotIntroStage3PlantAsses7cStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 4)
                {
                    if (!stage3Text4Read)
                    {
                        ...
                        jobotIntroStage3PlantAsses7bStage3.gameObject.SetActive(false);
                        jobotIntroStage3PlantAsses7cStage3.gameObject.SetActive(true);
                        jobotIntroStage3PlantAsses7dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 5)
                {
                    if (!stage3Text5Read)
                    {
                        ...
                        jobotIntroStage3PlantAsses7cStage3.gameObject.SetActive(false);
                        jobotIntroStage3PlantAsses7dStage3.gameObject.SetActive(true);
                        hangmanGamePanal.gameObject.SetActive(false);
                        LOLSDK.Instance.SpeakText("jobotStage2PlantWaterAssesmentCorrectText");
                ...
                if (currentStage3TreeText == 7)
                {
                    ...
                    if (!stage3Text7Read)
                    {
                        ...
                        jobotIntroStage3PlantAsses7IncorrectGuessStage3.gameObject.SetActive(true);
