...
{
    public class RoboGrowWaterplantsstageasses7 : MonoBehaviour
    {
        ...
        public Button TTSJobotPlantAsses7Stage4;
        public Button TTSJobotPlantAsses7aStage4;
        public Button TTSJobotPlantAsses7bStage4;
        public Button TTSJobotPlantAsses7cCorrectStage4;
        public Button TTSJobotIncorrectGuessStage4;

        public TextMeshProUGUI jobotIntroStage2PlantAsses7Stage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses7aStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses7bStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses7cCorrectStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses7IncorrectGuessStage4;
        #endregion
        ...
        public Button TTSJobotPlantAsses7Stage3;
        public Button TTSJobotPlantAsses7aStage3;
        public Button TTSJobotPlantAsses7bStage3;
        public Button TTSJobotPlantAsses7cStage3;
        public Button TTSJobotPlantAsses7dStage3;
        public Button TTSJobotIncorrectGuessAsses7Stage3;

        public TextMeshProUGUI jobotIntroStage3PlantAsses7Stage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses7aStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses7bStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses7cStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses7dStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses7IncorrectGuessStage3;
        ...
        private void Awake()
        {
            ...
            TTSJobotPlantAsses7Stage3.onClick.AddListener(JobotStage3Plant1Asses);
            TTSJobotPlantAsses7aStage3.onClick.AddListener(JobotStage3Plant1Asses2);
            TTSJobotPlantAsses7bStage3.onClick.AddListener(JobotStage3Plant1Asses3);
            TTSJobotPlantAsses7cStage3.onClick.AddListener(JobotStage3Plant1Asses4);
            TTSJobotPlantAsses7dStage3.onClick.AddListener(JobotStage3Plant1Asses5);
            TTSJobotIncorrectGuessAsses7Stage3.onClick.AddListener(JobotStage3Plant1Asses6);
            ...
            TTSJobotPlantAsses7Stage4.onClick.AddListener(JobotStage4Plant1Asses);
            TTSJobotPlantAsses7aStage4.onClick.AddListener(JobotStage4Plant1Asses2);
            TTSJobotPlantAsses7bStage4.onClick.AddListener(JobotStage4Plant1Asses3);
            TTSJobotPlantAsses7cCorrectStage4.onClick.AddListener(JobotStage4Plant1Asses4);
        ...
        void Start()
        {
            ...
            jobotIntroStage3PlantAsses7Stage3.enabled = false;
            jobotIntroStage3PlantAsses7aStage3.enabled = false;
            jobotIntroStage3PlantAsses7bStage3.enabled = false;
            jobotIntroStage3PlantAsses7cStage3.enabled = false;
            jobotIntroStage3PlantAsses7dStage3.enabled = false;
            jobotIntroStage3PlantAsses7IncorrectGuessStage3.enabled = false;
        ...
        void Update()
        {
            ...
            if (rgMain.currentGameStage == 3)
            {
                ...
                if (currentStage3TreeText == 1)
                {
                    ...
                    jobotIntroStage3PlantAsses7Stage3.enabled = true;
                    jobotIntroStage3PlantAsses7aStage3.enabled = false;
                    jobotIntroStage3PlantAsses7bStage3.enabled = false;
                    jobotIntroStage3PlantAsses7cStage3.enabled = false;
                    jobotIntroStage3PlantAsses7dStage3.enabled = false;
                    ...
                    TTSJobotPlantAsses7Stage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses7aStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7dStage3.gameObject.SetActive(false);

                    TTSJobotIncorrectGuessAsses7Stage3.gameObject.SetActive(false);
                    jobotIntroStage3PlantAsses7IncorrectGuessStage3.enabled = false;
                ...
                if (currentStage3TreeText == 2)
                {
                    ...
                    jobotIntroStage3PlantAsses7Stage3.enabled = false;
                    jobotIntroStage3PlantAsses7aStage3.enabled = true;
                    jobotIntroStage3PlantAsses7bStage3.enabled = false;
                    jobotIntroStage3PlantAsses7cStage3.enabled = false;
                    jobotIntroStage3PlantAsses7dStage3.enabled = false;


                    TTSJobotPlantAsses7Stage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7aStage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses7bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 3)
                {
                    ...
                    jobotIntroStage3PlantAsses7Stage3.enabled = false;
                    jobotIntroStage3PlantAsses7aStage3.enabled = false;
                    jobotIntroStage3PlantAsses7bStage3.enabled = true;
                    jobotIntroStage3PlantAsses7cStage3.enabled = false;
                    jobotIntroStage3PlantAsses7dStage3.enabled = false;
                    ...
                    TTSJobotPlantAsses7Stage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7aStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7bStage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses7cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 4)
                {
                    ...
                    jobotIntroStage3PlantAsses7aStage3.enabled = false;
                    jobotIntroStage3PlantAsses7bStage3.enabled = false;
                    jobotIntroStage3PlantAsses7cStage3.enabled = true;
                    jobotIntroStage3PlantAsses7dStage3.enabled = false;
                    ...
                    TTSJobotPlantAsses7aStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7cStage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses7dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 5)
                {
                    ...
                    jobotIntroStage3PlantAsses7bStage3.enabled = false;
                    jobotIntroStage3PlantAsses7cStage3.enabled = false;
                    jobotIntroStage3PlantAsses7dStage3.enabled = true;
                    hangmanGamePanal.gameObject.SetActive(false);
                    ...
                    TTSJobotPlantAsses7bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses7dStage3.gameObject.SetActive(true);
                ...
                if (currentStage3TreeText == 6)
                {
                    ...
                    hasGameBeenCompleted = false; //  robCont.enabled = true;
                    jobotIntroStage3PlantAsses7Stage3.enabled = false;
                    jobotIntroStage3PlantAsses7aStage3.enabled = false;
                    jobotIntroStage3PlantAsses7bStage3.enabled = false;
                    jobotIntroStage3PlantAsses7cStage3.enabled = false;
                ...
                if (currentStage3TreeText == 7)
                {
                    ...
                    TTSJobotIncorrectGuessAsses7Stage3.gameObject.SetActive(true);
                    jobotIntroStage3PlantAsses7IncorrectGuessStage3.enabled = true;
        ...
        public void ReturnToPlayerCamFromTreeFinal()
        {
            ...
            robotNavMeshAgentToStop.GetComponent<NavMeshAgent>().isStopped = false;
           // radish2ToDisable.gameObject.SetActive(false);
