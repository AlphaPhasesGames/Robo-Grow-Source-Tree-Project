            ...
            if (rgMain.currentGameStage == 3)
            {
                ...
                if (currentStage3TreeText == 2)
                {
                    if (!stage3Text2Read)
                    {
                        ...
                        jobotIntroStage3PlantAsses6Stage3.gameObject.SetActive(false);
                        jobotIntroStage3PlantAsses6aStage3.gameObject.SetActive(true);
                        jobotIntroStage3PlantAsses6bStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 3)
                {
                    if (!stage3Text3Read)
                    {
                        ...
                        jobotIntroStage3PlantAsses6aStage3.gameObject.SetActive(false);
                        jobotIntroStage3PlantAsses6bStage3.gameObject.SetActive(true);
                ...
                if (currentStage3TreeText == 4)
                {
                    if (!stage3Text4Read)
                    {
                        ...
                        jobotIntroStage3PlantAsses6bStage3.gameObject.SetActive(false);
                        jobotIntroStage3PlantAsses6cStage3.gameObject.SetActive(true);
                        jobotIntroStage3PlantAsses6dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 5)
                {
                    if (!stage3Text5Read)
                    {
                        ...
                        jobotIntroStage3PlantAsses6cStage3.gameObject.SetActive(false);
                        jobotIntroStage3PlantAsses6dStage3.gameObject.SetActive(true);
                        hangmanGamePanal.gameObject.SetActive(false);
