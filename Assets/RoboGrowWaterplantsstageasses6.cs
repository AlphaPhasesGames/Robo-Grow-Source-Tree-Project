...
{
    public class RoboGrowWaterplantsstageasses6 : MonoBehaviour
    {
        //For Daisy 2
        ...
        public Button TTSJobotPlantAsses6Stage3;
        public Button TTSJobotPlantAsses6aStage3;
        public Button TTSJobotPlantAsses6bStage3;
        public Button TTSJobotPlantAsses6cStage3;
        public Button TTSJobotPlantAsses6dStage3;
        public Button TTSJobotIncorrectGuessAsses6eStage3;

        public TextMeshProUGUI jobotIntroStage3PlantAsses6Stage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses6aStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses6bStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses6cStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses6dStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses6IncorrectGuessStage3;
        ...
        public Button TTSJobotPlantAsses6Stage4;
        public Button TTSJobotPlantAsses6aStage4;
        public Button TTSJobotPlantAsses6bStage4;
        public Button TTSJobotPlantAsses6cCorrectStage4;
        public Button TTSJobotIncorrectGuessStage4;

        public TextMeshProUGUI jobotIntroStage2PlantAsses6Stage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses6aStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses6bStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses6cCorrectStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses6IncorrectGuessStage4;
        #endregion
        ...
        private void Awake()
        {
            ...
            TTSJobotPlantAsses6Stage3.onClick.AddListener(JobotStage3Plant1Asses);
            TTSJobotPlantAsses6aStage3.onClick.AddListener(JobotStage3Plant1Asses2);
            TTSJobotPlantAsses6bStage3.onClick.AddListener(JobotStage3Plant1Asses3);
            TTSJobotPlantAsses6cStage3.onClick.AddListener(JobotStage3Plant1Asses4);
            TTSJobotPlantAsses6dStage3.onClick.AddListener(JobotStage3Plant1Asses5);
            TTSJobotIncorrectGuessAsses6eStage3.onClick.AddListener(JobotStage3Plant1Asses6);
            ...
            TTSJobotPlantAsses6Stage4.onClick.AddListener(JobotStage4Plant1Asses);
            TTSJobotPlantAsses6aStage4.onClick.AddListener(JobotStage4Plant1Asses2);
            TTSJobotPlantAsses6bStage4.onClick.AddListener(JobotStage4Plant1Asses3);
            TTSJobotPlantAsses6cCorrectStage4.onClick.AddListener(JobotStage4Plant1Asses4);
        ...
        void Start()
        {
            ...
            jobotIntroStage3PlantAsses6Stage3.enabled = false;
            jobotIntroStage3PlantAsses6aStage3.enabled = false;
            jobotIntroStage3PlantAsses6bStage3.enabled = false;
            jobotIntroStage3PlantAsses6cStage3.enabled = false;
            jobotIntroStage3PlantAsses6dStage3.enabled = false;
            jobotIntroStage3PlantAsses6IncorrectGuessStage3.enabled = false;

            jobotIntroStage2PlantAsses6Stage4.enabled = false;
            jobotIntroStage2PlantAsses6aStage4.enabled = false;
            jobotIntroStage2PlantAsses6bStage4.enabled = false;
            jobotIntroStage2PlantAsses6cCorrectStage4.enabled = false;
            jobotIntroStage2PlantAsses6IncorrectGuessStage4.enabled = false;
        ...
        void Update()
        {
            ...
            if (rgMain.currentGameStage == 3)
            {
                if (currentStage3TreeText == 1)
                {
                    ...
                    jobotIntroStage3PlantAsses6Stage3.enabled = true;
                    jobotIntroStage3PlantAsses6aStage3.enabled = false;
                    jobotIntroStage3PlantAsses6bStage3.enabled = false;
                    jobotIntroStage3PlantAsses6cStage3.enabled = false;
                    jobotIntroStage3PlantAsses6dStage3.enabled = false;
                    ...
                    TTSJobotPlantAsses6Stage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses6aStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6dStage3.gameObject.SetActive(false);

                    TTSJobotIncorrectGuessAsses6eStage3.gameObject.SetActive(false);
                    jobotIntroStage3PlantAsses6IncorrectGuessStage3.enabled = false;
                ...
                if (currentStage3TreeText == 2)
                {
                    ...
                    jobotIntroStage3PlantAsses6Stage3.enabled = false;
                    jobotIntroStage3PlantAsses6aStage3.enabled = true;
                    jobotIntroStage3PlantAsses6bStage3.enabled = false;
                    jobotIntroStage3PlantAsses6cStage3.enabled = false;
                    jobotIntroStage3PlantAsses6dStage3.enabled = false;


                    TTSJobotPlantAsses6Stage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6aStage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses6bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 3)
                {
                    ...
                    jobotIntroStage3PlantAsses6Stage3.enabled = false;
                    jobotIntroStage3PlantAsses6aStage3.enabled = false;
                    jobotIntroStage3PlantAsses6bStage3.enabled = true;
                    jobotIntroStage3PlantAsses6cStage3.enabled = false;
                    jobotIntroStage3PlantAsses6dStage3.enabled = false;
                    ...
                    TTSJobotPlantAsses6Stage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6aStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6bStage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses6cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 4)
                {
                    ...
                    jobotIntroStage3PlantAsses6aStage3.enabled = false;
                    jobotIntroStage3PlantAsses6bStage3.enabled = false;
                    jobotIntroStage3PlantAsses6cStage3.enabled = true;
                    jobotIntroStage3PlantAsses6dStage3.enabled = false;
                    ...
                    TTSJobotPlantAsses6aStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6cStage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses6dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 5)
                {
                    ...
                    jobotIntroStage3PlantAsses6bStage3.enabled = false;
                    jobotIntroStage3PlantAsses6cStage3.enabled = false;
                    jobotIntroStage3PlantAsses6dStage3.enabled = true;
                    hangmanGamePanal.gameObject.SetActive(false);
                    ...
                    TTSJobotPlantAsses6bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses6dStage3.gameObject.SetActive(true);
                ...
                if (currentStage3TreeText == 7)
                {
                    ...
                    TTSJobotIncorrectGuessAsses6eStage3.gameObject.SetActive(true);
            ...
            if (rgMain.currentGameStage == 4)
            {
                if (currentStage4TreeText == 1)
                {
                    ...
                    limaBean1plantBoxToDisable.enabled = false;
                    jobotIntroStage2PlantAsses6Stage4.enabled = true;
                    jobotIntroStage2PlantAsses6aStage4.enabled = false;
                    jobotIntroStage2PlantAsses6bStage4.enabled = false;
                    jobotIntroStage2PlantAsses6cCorrectStage4.enabled = false;

                    TTSJobotPlantAsses6Stage4.gameObject.SetActive(true);
                    TTSJobotPlantAsses6aStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses6bStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses6cCorrectStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 2)
                {
                    ...
                    susan1plantBoxToDisable.enabled = false;
                    jobotIntroStage2PlantAsses6Stage4.enabled = false;
                    jobotIntroStage2PlantAsses6aStage4.enabled = true;
                    jobotIntroStage2PlantAsses6bStage4.enabled = false;
                    jobotIntroStage2PlantAsses6cCorrectStage4.enabled = false;
                    mazeGamePanal.gameObject.SetActive(true);
                    TTSJobotPlantAsses6Stage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses6aStage4.gameObject.SetActive(true);
                    TTSJobotPlantAsses6bStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses6cCorrectStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 3)
                {
                    ...
                    jobotIntroStage2PlantAsses6Stage4.enabled = false;
                    jobotIntroStage2PlantAsses6aStage4.enabled = false;
                    jobotIntroStage2PlantAsses6bStage4.enabled = true;
                    jobotIntroStage2PlantAsses6cCorrectStage4.enabled = false;
                    mazeGamePanal.gameObject.SetActive(true);

                    TTSJobotPlantAsses6Stage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses6aStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses6bStage4.gameObject.SetActive(true);
                    TTSJobotPlantAsses6cCorrectStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 4)
                {
                    ...
                    jobotIntroStage2PlantAsses6aStage4.enabled = false;
                    jobotIntroStage2PlantAsses6bStage4.enabled = false;
                    jobotIntroStage2PlantAsses6cCorrectStage4.enabled = true;
                    mazeGamePanal.gameObject.SetActive(false);

                    TTSJobotPlantAsses6Stage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses6aStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses6bStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses6cCorrectStage4.gameObject.SetActive(true);
                ...
                if (currentStage4TreeText == 5)
                {
                    ...
                    jobotIntroStage2PlantAsses6IncorrectGuessStage4.enabled = true;
        ...
        public void ReturnToPlayerCamFromTreeFinal()
        {
            ...
            robotNavMeshAgentToStop.GetComponent<NavMeshAgent>().isStopped = false;
            daisy2ToDisable.gameObject.SetActive(false);
        ...
        public IEnumerator ShowIncorrectGuess()
        {
            ...
            ReturnToPlayerCamFromTree();
            daisy2plantBoxToDisable.gameObject.SetActive(false);
            robCont.NewNavmeshStop();
