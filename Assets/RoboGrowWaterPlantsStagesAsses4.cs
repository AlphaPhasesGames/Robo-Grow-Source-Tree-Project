...
{
    public class RoboGrowWaterPlantsStagesAsses4 : MonoBehaviour
    {
        //Daisy 1
        ...
        public Button TTSJobotPlantAsses4Stage3;
        public Button TTSJobotPlantAsses4aStage3;
        public Button TTSJobotPlantAsses4bStage3;
        public Button TTSJobotPlantAsses4cStage3;
        public Button TTSJobotPlantAsses4dStage3;
        public Button TTSJobotIncorrectGuessAsses4eStage3;

        public TextMeshProUGUI jobotIntroStage3PlantAsses4Stage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses4aStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses4bStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses4cStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses4dStage3;
        public TextMeshProUGUI jobotIntroStage3PlantAsses4IncorrectGuessStage3;
        ...
        public Button TTSJobotPlantAsses4Stage4;
        public Button TTSJobotPlantAsses4aStage4;
        public Button TTSJobotPlantAsses4bStage4;
        public Button TTSJobotPlantAsses4cCorrectStage4;
        public Button TTSJobotIncorrectGuessStage4;

        public TextMeshProUGUI jobotIntroStage2PlantAsses4Stage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses4aStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses4bStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses4cCorrectStage4;
        public TextMeshProUGUI jobotIntroStage2PlantAsses4IncorrectGuessStage4;
        #endregion
        ...
        private void Awake()
        {
            ...
            TTSJobotPlantAsses4Stage3.onClick.AddListener(JobotStage3Plant1Asses);
            TTSJobotPlantAsses4aStage3.onClick.AddListener(JobotStage3Plant1Asses2);
            TTSJobotPlantAsses4bStage3.onClick.AddListener(JobotStage3Plant1Asses3);
            TTSJobotPlantAsses4cStage3.onClick.AddListener(JobotStage3Plant1Asses4);
            TTSJobotPlantAsses4dStage3.onClick.AddListener(JobotStage3Plant1Asses5);
            TTSJobotIncorrectGuessAsses4eStage3.onClick.AddListener(JobotStage3Plant1Asses6);
            ...
            TTSJobotPlantAsses4Stage4.onClick.AddListener(JobotStage4Plant1Asses);
            TTSJobotPlantAsses4aStage4.onClick.AddListener(JobotStage4Plant1Asses2);
            TTSJobotPlantAsses4bStage4.onClick.AddListener(JobotStage4Plant1Asses3);
            TTSJobotPlantAsses4cCorrectStage4.onClick.AddListener(JobotStage4Plant1Asses4);
        ...
        void Start()
        {
            ...
            jobotIntroStage3PlantAsses4Stage3.enabled = false;
            jobotIntroStage3PlantAsses4aStage3.enabled = false;
            jobotIntroStage3PlantAsses4bStage3.enabled = false;
            jobotIntroStage3PlantAsses4cStage3.enabled = false;
            jobotIntroStage3PlantAsses4dStage3.enabled = false;
            jobotIntroStage3PlantAsses4IncorrectGuessStage3.enabled = false;

            jobotIntroStage2PlantAsses4Stage4.enabled = false;
            jobotIntroStage2PlantAsses4aStage4.enabled = false;
            jobotIntroStage2PlantAsses4bStage4.enabled = false;
            jobotIntroStage2PlantAsses4cCorrectStage4.enabled = false;
            jobotIntroStage2PlantAsses4IncorrectGuessStage4.enabled = false;
        ...
        void Update()
        {
            ...
            if (rgMain.currentGameStage == 3)
            {
                if (currentStage3TreeText == 1)
                {
                    ...
                    jobotIntroStage3PlantAsses4Stage3.enabled = true;
                    jobotIntroStage3PlantAsses4aStage3.enabled = false;
                    jobotIntroStage3PlantAsses4bStage3.enabled = false;
                    jobotIntroStage3PlantAsses4cStage3.enabled = false;
                    jobotIntroStage3PlantAsses4dStage3.enabled = false;
                    ...
                    TTSJobotPlantAsses4Stage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses4aStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4dStage3.gameObject.SetActive(false);

                    TTSJobotIncorrectGuessAsses4eStage3.gameObject.SetActive(false);
                    jobotIntroStage3PlantAsses4IncorrectGuessStage3.enabled = false;
                ...
                if (currentStage3TreeText == 2)
                {
                    ...
                    jobotIntroStage3PlantAsses4Stage3.enabled = false;
                    jobotIntroStage3PlantAsses4aStage3.enabled = true;
                    jobotIntroStage3PlantAsses4bStage3.enabled = false;
                    jobotIntroStage3PlantAsses4cStage3.enabled = false;
                    jobotIntroStage3PlantAsses4dStage3.enabled = false;


                    TTSJobotPlantAsses4Stage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4aStage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses4bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 3)
                {
                    ...
                    jobotIntroStage3PlantAsses4Stage3.enabled = false;
                    jobotIntroStage3PlantAsses4aStage3.enabled = false;
                    jobotIntroStage3PlantAsses4bStage3.enabled = true;
                    jobotIntroStage3PlantAsses4cStage3.enabled = false;
                    jobotIntroStage3PlantAsses4dStage3.enabled = false;
                    ...
                    TTSJobotPlantAsses4Stage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4aStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4bStage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses4cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 4)
                {
                    ...
                    jobotIntroStage3PlantAsses4aStage3.enabled = false;
                    jobotIntroStage3PlantAsses4bStage3.enabled = false;
                    jobotIntroStage3PlantAsses4cStage3.enabled = true;
                    jobotIntroStage3PlantAsses4dStage3.enabled = false;
                    ...
                    TTSJobotPlantAsses4aStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4cStage3.gameObject.SetActive(true);
                    TTSJobotPlantAsses4dStage3.gameObject.SetActive(false);
                ...
                if (currentStage3TreeText == 5)
                {
                    ...
                    jobotIntroStage3PlantAsses4bStage3.enabled = false;
                    jobotIntroStage3PlantAsses4cStage3.enabled = false;
                    jobotIntroStage3PlantAsses4dStage3.enabled = true;
                    hangmanGamePanal.gameObject.SetActive(false);
                    ...
                    TTSJobotPlantAsses4bStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4cStage3.gameObject.SetActive(false);
                    TTSJobotPlantAsses4dStage3.gameObject.SetActive(true);
                ...
                if (currentStage3TreeText == 7)
                {
                    ...
                    TTSJobotIncorrectGuessAsses4eStage3.gameObject.SetActive(true);
                    jobotIntroStage3PlantAsses4IncorrectGuessStage3.enabled = true;
            ...
            if (rgMain.currentGameStage == 4)
            {
                if (currentStage4TreeText == 1)
                {
                    ...
                    limaBean1plantBoxToDisable.enabled = false;
                    jobotIntroStage2PlantAsses4Stage4.enabled = true;
                    jobotIntroStage2PlantAsses4aStage4.enabled = false;
                    jobotIntroStage2PlantAsses4bStage4.enabled = false;
                    jobotIntroStage2PlantAsses4cCorrectStage4.enabled = false;

                    TTSJobotPlantAsses4Stage4.gameObject.SetActive(true);
                    TTSJobotPlantAsses4aStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses4bStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses4cCorrectStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 2)
                {
                    ...
                    susan1plantBoxToDisable.enabled = false;
                    jobotIntroStage2PlantAsses4Stage4.enabled = false;
                    jobotIntroStage2PlantAsses4aStage4.enabled = true;
                    jobotIntroStage2PlantAsses4bStage4.enabled = false;
                    jobotIntroStage2PlantAsses4cCorrectStage4.enabled = false;
                    mazeGamePanal.gameObject.SetActive(true);
                    TTSJobotPlantAsses4Stage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses4aStage4.gameObject.SetActive(true);
                    TTSJobotPlantAsses4bStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses4cCorrectStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 3)
                {
                    ...
                    jobotIntroStage2PlantAsses4Stage4.enabled = false;
                    jobotIntroStage2PlantAsses4aStage4.enabled = false;
                    jobotIntroStage2PlantAsses4bStage4.enabled = true;
                    jobotIntroStage2PlantAsses4cCorrectStage4.enabled = false;
                    mazeGamePanal.gameObject.SetActive(true);

                    TTSJobotPlantAsses4Stage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses4aStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses4bStage4.gameObject.SetActive(true);
                    TTSJobotPlantAsses4cCorrectStage4.gameObject.SetActive(false);
                ...
                if (currentStage4TreeText == 4)
                {
                    ...
                    jobotIntroStage2PlantAsses4aStage4.enabled = false;
                    jobotIntroStage2PlantAsses4bStage4.enabled = false;
                    jobotIntroStage2PlantAsses4cCorrectStage4.enabled = true;
                    mazeGamePanal.gameObject.SetActive(false);

                    TTSJobotPlantAsses4Stage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses4aStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses4bStage4.gameObject.SetActive(false);
                    TTSJobotPlantAsses4cCorrectStage4.gameObject.SetActive(true);
                ...
                if (currentStage4TreeText == 5)
                {
                    ...
                    jobotIntroStage2PlantAsses4IncorrectGuessStage4.enabled = true;
        ...
        public void ReturnToPlayerCamFromTreeFinal()
        {
            ...
            robotNavMeshAgentToStop.GetComponent<NavMeshAgent>().isStopped = false;
            daisyToDisable.gameObject.SetActive(false);
        ...
        public IEnumerator ShowIncorrectGuess()
        {
            ...
            ReturnToPlayerCamFromTree();
            daisy1plantBoxToDisable.gameObject.SetActive(false);
            robCont.NewNavmeshStop();
